...
const Navigation: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-surface/90 backdrop-blur-sm border-b border-border shadow-sm">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {isOpen && (
          <div className="md:hidden py-4 border-t border-border bg-surface text-foreground">
            <div className="flex flex-col space-y-4">
              ...
              <a href="https://dashboard.nick-ai.link" className="bg-primary text-primary-foreground px-4 py-2 rounded-lg text-center hover:bg-primary/90 transition-colors">
                Dashboard
              </a>
            </div>
          </div>
