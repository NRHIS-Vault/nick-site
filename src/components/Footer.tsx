    ...
    <footer className="bg-surface text-foreground py-12 border-t border-border">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-bold bg-gradient-to-r from-brand to-brand-strong bg-clip-text text-transparent mb-4">
              RHNIS
            </h3>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="text-muted-foreground hover:text-primary transition-colors"
                aria-label="Follow RHNIS on Threads"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
